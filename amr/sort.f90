...
SUBROUTINE quick_sort_int_i8b(list, order, n)
  ...
  INTEGER(i8b), DIMENSION (1:n), INTENT(INOUT)  :: order


  CALL quick_sort_1_int_i8b(1_i8b, n)

CONTAINS

  RECURSIVE SUBROUTINE quick_sort_1_int_i8b(left_end, right_end)

    INTEGER(i8b), INTENT(IN) :: left_end, right_end

    !     Local variables
    INTEGER(i8b)             :: i, j, itemp
    INTEGER(i8b)             :: reference, temp
    INTEGER(i8b), PARAMETER  :: max_simple_sort_size = 6
    ...
    ELSE
      ...
      DO
          ...
          END IF
       END DO
       IF (left_end < j) CALL quick_sort_1_int_i8b(left_end, j)
       IF (i < right_end) CALL quick_sort_1_int_i8b(i, right_end)
    END IF

  END SUBROUTINE quick_sort_1_int_i8b
...
END SUBROUTINE quick_sort_int_i8b
