module amr_parameters
  ...
  real(dp)::t_startIa=38.6d6  !Default: First SNIa after lifetime (years) of 8Msun star
  ...
  real(dp)::tauIRmax=100.          ! infrared optical depth limiter
  ...
  character(len=80) :: AGByieldfile,SNIIyieldfile,OByieldfile,SNIayieldfile
  integer,dimension(1:118) :: metal_list=-1

  integer :: nmass_AGB, nmet_AGB
  integer :: nmass_SNII, nmet_SNII
  integer :: nmass_OBwind, nmet_OBwind


  character(len=2),dimension(:),allocatable :: met_keys
  real(dp),dimension(:,:,:),allocatable :: AGB_yields,SNII_yields,OBwind_yields
  real(dp),dimension(:,:),allocatable :: AGB_mloss,SNII_mloss,OBwind_mloss
  real(dp),dimension(:),allocatable :: SNIa_yields
  real(dp), dimension(:),allocatable :: ytable_met_AGB, ytable_mass_AGB
  real(dp), dimension(:),allocatable :: ytable_met_SNII, ytable_mass_SNII
  real(dp), dimension(:),allocatable :: ytable_met_OBwind, ytable_mass_OBwind
  !-------------------------------------  

  integer ::metal=0                     ! metal=0: no metal tracking (Z = z_ave), metal=1: metalicity tracked by Z=1-(H+He), metal=2: metal tracked by separate variable
