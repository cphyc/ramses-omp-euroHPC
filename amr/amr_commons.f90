module amr_commons
  ...
  integer::nlevelmax_current=0                  ! Current maximum levelmax for cosmological simulations
  ...
  integer                       ::magic_number=2*10 ! Magic number, relative cost between particle and cells
